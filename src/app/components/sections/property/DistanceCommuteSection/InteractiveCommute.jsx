...
const INITIAL_DATA = {
  frequent: {
    ...
    items: [
      { id: 'f1', name: 'Workplace - Hitech City', time: '45 min', distance: '18.2 km', mode: 'drive', color: '#E76F26', icon: 'building' },
    ]
  },
  education: {
    ...
    items: [
      { id: 'e1', name: 'Ryan International School', time: '6 min',  distance: '1.8 km', mode: 'drive', color: '#E76F26', icon: 'school' },
      { id: 'e2', name: 'Delhi Public School',        time: '9 min',  distance: '3.1 km', mode: 'drive', color: '#E76F26', icon: 'school' },
    ]
  },
  emergency: {
    ...
    items: [
      { id: 'em1', name: 'Apollo Hospital', time: '9 min', distance: '2.3 km', mode: 'drive', color: '#E76F26', icon: 'hospital' },
    ]
  }
};
...
function PlaceIcon({ icon, color }) {
  return (
    <div
      className="w-11 h-11 flex-shrink-0 flex items-center justify-center rounded-[7px] shadow-sm bg-[#F4EFE6] text-[#E76F26]"
    >
...
export default function InteractiveCommute() {
  ...
  return (
    <div className="w-full font-['Outfit',_sans-serif]">
      <div className="w-full bg-[#FDFBF8] overflow-hidden flex flex-col rounded-[7px] border border-[#E5DFD4]/60 shadow-sm">

        <div className="flex overflow-x-auto scrollbar-hide border-b border-[#E5DFD4] whitespace-nowrap relative z-20 bg-white">
          {TABS.map((tab) => {
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  <div className="absolute bottom-0 left-0 right-0 h-[3px] rounded-t-[3px]" style={{ backgroundColor: tab.color }} />
                )}
              </button>
            );
          })}
        ...
        <div className="p-3 bg-[#F9F7F2] flex-1 rounded-b-[7px]">

          {successToast && (
            <div className="flex items-center gap-2 bg-[#F4EFE6] text-[#322822] px-4 py-3 rounded-[7px] mb-4 text-[13px] font-semibold border border-[#E5DFD4] shadow-sm">
              <Icons.Check />
              {successToast}
            </div>
          )}
          ...
          {isAddingPlace ? (
            <div className="flex flex-col -mx-4 -mt-4">
              ...
              <div className="px-5 pt-5 pb-3 bg-white border-b border-[#E5DFD4]">
                <h3 className="text-[15px] font-semibold text-[#322822] tracking-tight">
                  Add to My Frequent Places
                </h3>
              </div>

              <div className="px-5 pt-4 pb-3 bg-white">
                <label className="text-[11px] font-medium text-[#8A7D74] tracking-widest mb-1.5 block">
                  Search Location
                </label>
                <div className="flex items-center bg-[#F9F7F2] rounded-[7px] px-3.5 py-3 border border-[#E5DFD4] focus-within:border-[#E76F26] focus-within:bg-white transition-all">
                  <Icons.Search />
                  <input
                    type="text"
              ...
              <div className="h-[190px] bg-[#EBE4D8] relative overflow-hidden">
                <div
                  className="absolute inset-0 opacity-20 pointer-events-none"
                  style={{ backgroundImage: 'radial-gradient(#8A7D74 1px, transparent 1px)', backgroundSize: '22px 22px' }}
                />
                <svg className="absolute inset-0 w-full h-full opacity-15" preserveAspectRatio="none" viewBox="0 0 400 190">
                  <line x1="0"   y1="95"  x2="400" y2="95"  stroke="#8A7D74" strokeWidth="7" />
                  <line x1="200" y1="0"   x2="200" y2="190" stroke="#8A7D74" strokeWidth="5" />
                  <line x1="0"   y1="45"  x2="400" y2="145" stroke="#8A7D74" strokeWidth="2.5" />
                </svg>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-full flex flex-col items-center drop-shadow-lg">
                  <div className="bg-[#E76F26] text-white px-3 py-1 rounded-[7px] text-[12.5px] font-semibold shadow-sm mb-1 max-w-[200px] truncate">
              ...
              <div className="bg-white px-5 pt-4 pb-5">
                ...
                <div className="flex items-center bg-[#F9F7F2] rounded-[7px] px-3.5 py-3 border border-[#E5DFD4] focus-within:border-[#E76F26] focus-within:bg-white transition-all mb-4">
                  <Icons.Tag />
                  <input
                    type="text"
                    placeholder="e.g. My Office, Gym, Parent's Home"
                    className="bg-transparent border-none outline-none w-full ml-2.5 text-[14px] text-[#322822] font-semibold placeholder-[#8A7D74]/70"
                    value={placeName}
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 py-3 rounded-[7px] border border-[#E5DFD4] text-[#8A7D74] font-semibold text-[13.5px] hover:bg-[#F4EFE6]/50 hover:border-[#E5DFD4] transition-all"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="flex-[1.5] py-3 rounded-[7px] text-white font-semibold text-[13.5px] disabled:opacity-40 active:scale-[0.98] transition-all shadow-sm hover:shadow-md disabled:shadow-none bg-[#E76F26]"
                  >
                    Save Place
                  </button>
                </div>
            ...
            <div className="flex flex-col h-full">
              ...
              {currentData.items.length === 0 && (
                <div className="border border-dashed border-[#E5DFD4] rounded-[7px] p-6 flex flex-col items-center justify-center text-center bg-white mb-4">
                  ...
                  <p className="text-[12px] text-[#8A7D74] font-medium">Tap below to add a location</p>
                </div>
              )}
              ...
              <div className="flex flex-col gap-2 mb-3">
                {currentData.items.map((item) => (
                  <div
                    key={item.id}
                    className="flex items-center gap-3 p-3.5 rounded-[7px] border border-[#E5DFD4]/60 bg-white hover:border-[#E5DFD4] hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 cursor-pointer shadow-sm"
                  >
              ...
              {activeTab === 'frequent' && (
                <button
                  ...
                  className="w-full py-2.5 rounded-[7px] border border-dashed border-[#E5DFD4] text-[#E76F26] font-semibold text-[13.5px] flex items-center justify-center gap-2 transition-all duration-200 hover:bg-[#F4EFE6]/50 bg-white mb-1"
                >
