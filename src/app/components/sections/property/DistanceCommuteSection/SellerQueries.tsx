...
export default function SellerQueries() {
  ...
  const handleAddCustom = (e?: React.FormEvent) => {
    ...
    if (customInput.trim()) {
      ...
      if (!questions.includes(newQuestion)) {
        ...
        setShowMore(true); // Ensure they can see what they just added
      }
      setCustomInput("");
      setIsAdding(false);
    }
  ...
  return (
    <div className="max-w-[400px] mx-auto py-4 px-3 space-y-4 font-['Outfit',_sans-serif] bg-white rounded-xl shadow-sm border border-[#F5F2ED]">
      ...
      <div className="pt-2">
        <button 
          className="w-full bg-[#322822] text-white font-bold py-3 rounded-lg text-[15px] shadow-sm active:scale-[0.98] transition-all disabled:opacity-30"
