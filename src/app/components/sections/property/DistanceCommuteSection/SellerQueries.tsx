...
export default function SellerQueries() {
  const [unitQuestions, setUnitQuestions] = useState(initialUnitQuestions);
  const [extraQuestions, setExtraQuestions] = useState(initialExtraQuestions);
  ...
  const handleAddCustom = (e?: React.FormEvent) => {
    ...
    if (trimmed) {
      setUnitQuestions((prev) => [trimmed, ...prev]);
